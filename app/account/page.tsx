...
export default async function AccountPage() {
  ...
  const assetResult: { assets?: SolanaAssetBalance[]; error?: boolean } | null = wallet ? await getMainSolanaAssetBalances(wallet.address, env.SOLANA_RPC_URL ?? 'https://api.mainnet-beta.solana.com').then(assets => ({ assets })).catch(() => ({ error: true })) : null;
