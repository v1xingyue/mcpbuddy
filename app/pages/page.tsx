...
export default async function PagesManager() {
  ...
  return <AppShell active="pages" name={session.user.name}><header className="app-page-head"><p className="eyebrow">DATA LIBRARY</p><h1>Pages</h1><p>Manage private pages and public share links published by your AI clients.</p></header><PageList pages={pages} /></AppShell>;
}
